...
public class Llamada1 extends Expresion {
    ...
    public Llamada1(String id, LinkedList<Expresion> parametros, int fila, int columna) {
        super("ERROR LLAMADA EXPRESION", TipoDato.ERROR,fila, columna);
        this.id = id;
    ...
    public Object interpretar(Entorno ent, tablaSimbolos ts){
        ...
        System.out.println("Error en la llamada a la funcion");
        Errores.errores.add(new Errores("Semantico","Error en la llamada a la funcion", fila, columna));
        return new Errores("Semantico","Error en la llamada a la funcion", fila, columna);
    }
    }
